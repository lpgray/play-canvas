...
function popupLoginContainer(config) {
    ...
    $("body").append("<div id=\"modalOverlay\" style=\"opacity: 0.3;filter:Alpha(opacity=30);background:none repeat scroll 0 0 #000000;position: absolute;border: 0 none;width: 100%;height: 100%;top: 0;left: 0;z-index:10097;\"></div><div id=\"modalContainer\" style=\"z-index:10098;position:fixed;_position: absolute;\"></div>");
    $("#modalOverlay").hide();
